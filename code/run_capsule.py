...
if __name__ == "__main__":
    ...
    # Use CO_CPUS/SLURM_CPUS_PER_TASK/SLURM_CPUS_ON_NODE env variable if available
    N_JOBS_EXT = os.getenv("CO_CPUS") or os.getenv("SLURM_CPUS_PER_TASK") or os.getenv("SLURM_CPUS_ON_NODE")
